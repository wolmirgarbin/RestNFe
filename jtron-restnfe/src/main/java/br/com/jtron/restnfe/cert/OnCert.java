...
public class OnCert {  
    ...
    public static String funcStatusCertificado(X509Certificate crtCertificado) {  
        ...
        try {  
            ...
            return "Certificado v�lido at�"+crtCertificado.getNotAfter();  
    ...
    public static X509Certificate funcCertificadoSelecionado(String strAliasTokenCert, String strSenhaCertificado) throws NoSuchProviderException, IOException, NoSuchAlgorithmException, CertificateException, UnrecoverableEntryException, KeyStoreException {  
    ...
    public static KeyStore.PrivateKeyEntry funcPrivateKeyEntry(String strAliasTokenCert, String strSenhaCertificado) throws NoSuchProviderException, IOException, NoSuchAlgorithmException, CertificateException, UnrecoverableEntryException, KeyStoreException {  
          
        //KeyStore crtRepositorio = null;  

        //KeyStore.PrivateKeyEntry keyEntry;   
        return (KeyStore.PrivateKeyEntry) funcKeyStore(strAliasTokenCert).getEntry(strAliasTokenCert, new KeyStore.PasswordProtection(strSenhaCertificado.toCharArray()));          
    ...
    public static boolean funcAssinaXML(TAssinaXML tpAssinaXML, String operacao) throws Exception {  
        ...
        X509Certificate cert = funcCertificadoSelecionado(tpAssinaXML.strAliasTokenCert,  tpAssinaXML.strSenhaCertificado);  
